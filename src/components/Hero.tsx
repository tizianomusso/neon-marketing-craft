      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 pt-20">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm text-muted-foreground">Agencia #1 en resultados digitales</span>
          </motion.div>
          ...
          >
            ...
            <a
              href="#portfolio"
              className="group px-8 py-4 rounded-xl font-semibold text-foreground border border-border hover:border-primary/50 hover:bg-primary/5 transition-all duration-300 flex items-center gap-2"
            >
